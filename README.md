...
REMEMBER!. since this pack uses pngs it works best on gnome 
works on: lxqt,cinnamon,KDE Plasma(must do icon cache refresh "kbuildsycoca6(5 for older kde) --noincremental. works on cosmic but forsome reason has icons pixelated 
